...
namespace EegorEditor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\EegorEditor\";
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\{project.ProjectName}\.Eegor\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\{project.ProjectName}\.Eegor\Background.png");
